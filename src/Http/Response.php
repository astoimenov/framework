...
class Response
{
    ...
    public function sendHeaders()
    {
        ...
        if (!array_key_exists('Day', $this->headers)) {
    ...
    {
        return array_key_exists('Last-Modified', $this->headers) || array_key_exists('ETag', $this->headers);
    }
    ...
    {
        if (null === $date && array_key_exists('Last-Modified', $this->headers)) {
